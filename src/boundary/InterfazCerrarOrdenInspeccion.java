...
public class InterfazCerrarOrdenInspeccion extends JFrame {
    ...
    public InterfazCerrarOrdenInspeccion() {
        ...
        botonCancelar.addActionListener(e -> gestor.cancelar());
    ...
    public void habilitarPantalla() {
        ...
        botonCerrarOrden.setVisible(false);
    ...
    public void tomarConfirmacionCierreOrden(boolean confirmacion){
        ...
        panelPrincipal.revalidate();
        panelPrincipal.repaint();
        //botonCerrarOrden.setVisible(true);
        gestor.tomarConfirmacionCierreOrden(confirmacion);
    }

    public void mostrarMensajeError(String mensaje) {
        JOptionPane.showMessageDialog(this, mensaje, "Atención", JOptionPane.ERROR_MESSAGE);
        gestor.cancelar();
    }
