...
public class DataLoader {
    ...
    public static void loadInitialData() {
        ...
        try {
            ...
            if (count > 0) {
                System.out.println("✓ Datos ya existentes en la base de datos. No se cargarán datos iniciales.");
                em.close();
                return;
            }
            ...
            // ROLES
            Rol rolResponsable = new Rol("ResponsableReparacion", "Encargado de coordinar y realizar reparaciones del sismógrafo");
            ...
            Rol rolAdministrador = new Rol("Administrador", "Gestiona usuarios y configuraciones del sistema");
            ...
            // EMPLEADOS
            Empleado lucia = new Empleado("Lucía", "Gómez", "lucia.gomez@sismo.gob.ar", "3511234567", rolResponsable);
            Empleado martin = new Empleado("Martín", "Fernández", "martin.fernandez@sismo.gob.ar", "3512345678", rolResponsable);
            Empleado sofia = new Empleado("Sofía", "López", "sofia.lopez@sismo.gob.ar", "3513456789", rolResponsable);
            Empleado carlos = new Empleado("Carlos", "Ramírez", "carlos.ramirez@sismo.gob.ar", "3514567890", rolSupervisor);
            Empleado ana = new Empleado("Ana", "Torres", "ana.torres@sismo.gob.ar", "3515678901", rolAdministrador);
            ...
            CambioEstado cambio1 = new CambioEstado(LocalDateTime.of(2024, 10, 1, 8, 0), null, lucia, estadoEnServicio);
            CambioEstado cambio2 = new CambioEstado(LocalDateTime.of(2024, 10, 5, 9, 30), null, martin, estadoEnServicio);
            CambioEstado cambio3 = new CambioEstado(LocalDateTime.of(2024, 10, 10, 14, 15), null, sofia, estadoEnServicio);
            ...
            Sismografo sis1 = new Sismografo(java.sql.Date.valueOf("2020-06-15"), "SIS-001", 1001, null, cambio1, estadoEnServicio);
            Sismografo sis2 = new Sismografo(java.sql.Date.valueOf("2021-09-10"), "SIS-002", 1002, null, cambio2, estadoEnServicio);
            Sismografo sis3 = new Sismografo(java.sql.Date.valueOf("2022-01-25"), "SIS-003", 1003, null, cambio3, estadoEnServicio);
            ...
            // Actualizar los sismógrafos con la referencia a las estaciones (usar setter si existe)
            ...
            OrdenDeInspeccion orden6 = new OrdenDeInspeccion(
                ...
                martin, estacion2, estadoCompletamenteRealizada
            );
            ...
            OrdenDeInspeccion orden8 = new OrdenDeInspeccion(
                ...
                sofia, estacion1, estadoCompletamenteRealizada
            );
